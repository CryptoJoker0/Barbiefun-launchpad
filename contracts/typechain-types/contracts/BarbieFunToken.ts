...
export interface BarbieFunTokenInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "allowance"
      | "approve"
...
export interface BarbieFunToken extends BaseContract {
  connect(runner?: ContractRunner | null): BarbieFunToken;
  waitForDeployment(): Promise<this>;

  interface: BarbieFunTokenInterface;
