...
export default function Ticker() {
  ...
  return (
    <div className="bg-gradient-to-r from-pink-600 via-pink-500 to-pink-700 border-b border-pink-700/40 overflow-hidden py-1.5 flex items-center text-xs font-mono">
