          ...
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex items-center space-x-2 sm:space-x-3">
              ...
              <Link href="/bridge" className="hidden sm:block">
                <button className="flex items-center justify-center w-9 h-9 rounded-full bg-pink-50 hover:bg-pink-100 border border-pink-200 transition-colors text-pink-600" title="Bridge">
                  <ArrowLeftRight className="w-4 h-4" />
                </button>
              </Link>
              <Link href="/swap" className="hidden sm:block">
                <Button variant="outline" className="border-pink-300 text-pink-700 hover:bg-pink-50 font-bold rounded-full px-4 shadow-sm">
            ...
            <div className="md:hidden border-t border-pink-100 py-3 space-y-1">
              ...
              {anyConnected && (
                <button onClick={() => { disconnect(); solana.disconnect(); setMobileOpen(false); }}
                  className="mx-4 mt-1 flex items-center space-x-2 text-sm text-red-500 font-semibold">
